...
pub type SDIOIRQFORSLOTA_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `SDIOIRQforSlotB` writer - "]
pub type SDIOIRQFORSLOTB_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn sdioirqfor_slot_a(&mut self) -> SDIOIRQFORSLOTA_W<8> {
        SDIOIRQFORSLOTA_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sdioirqfor_slot_b(&mut self) -> SDIOIRQFORSLOTB_W<9> {
        SDIOIRQFORSLOTB_W::new(self)
    }
