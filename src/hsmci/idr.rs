...
pub type SDIOIRQFORSLOTA_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR_SPEC, bool, O>;
#[doc = "Field `SDIOIRQforSlotB` writer - "]
pub type SDIOIRQFORSLOTB_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR_SPEC, bool, O>;
