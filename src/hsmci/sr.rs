...
pub type SDIOIRQFORSLOTA_R = crate::BitReader<bool>;
#[doc = "Field `SDIOIRQforSlotB` reader - "]
pub type SDIOIRQFORSLOTB_R = crate::BitReader<bool>;
...
impl R {
    ...
    pub fn sdioirqfor_slot_a(&self) -> SDIOIRQFORSLOTA_R {
        SDIOIRQFORSLOTA_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sdioirqfor_slot_b(&self) -> SDIOIRQFORSLOTB_R {
        SDIOIRQFORSLOTB_R::new(((self.bits >> 9) & 1) != 0)
    }
